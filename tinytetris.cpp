...
U();}return 1;}I L(){while(T()){usleep(10000);if((c=getch())==104&&x>0&&!C(x-1,y
,r))x--;if(c==108&&x+N(r,16)<9&&!C(x+1,y,r))x++;if(c==106){while(!C(x,y+1,r)){y++
;U();}R();P();}if(c==107){++r%=4;while(x+N(r,16)>9)x--;if(C(x,y,r)){x=f;r=h;}}if
